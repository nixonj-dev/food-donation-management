        ...
        <div class="dash-content">
            <div class="overview">
                ...
                <script>
                    ...
                    $q6 = "SELECT count(*) as count FROM food_donations where location=\"tiruchirappalli\"";
                    $res6 = mysqli_query($connection, $q6);
                    $ro6 = mysqli_fetch_assoc($res6);
                    $tiruchirappalli = $ro6['count'];
                    $q7 = "SELECT count(*) as count FROM food_donations where location=\"kancheepuram\"";
                    $res7 = mysqli_query($connection, $q7);
                    $ro7 = mysqli_fetch_assoc($res7);
                    $kancheepuram = $ro7['count'];
                    $q8 = "SELECT count(*) as count FROM food_donations where location=\"thiruvallur\"";
                    $res8 = mysqli_query($connection, $q8);
                    $ro8 = mysqli_fetch_assoc($res8);
                    $thiruvallur = $ro8['count'];
                    $q9 = "SELECT count(*) as count FROM food_donations where location=\"vellore\"";
                    $res9 = mysqli_query($connection, $q9);
                    $ro9 = mysqli_fetch_assoc($res9);
                    $vellore = $ro9['count'];
                    $q10 = "SELECT count(*) as count FROM food_donations where location=\"tiruvallur\"";
                    $res10= mysqli_query($connection, $q10);
                    $ro10 = mysqli_fetch_assoc($res10);
                    $tiruvallur = $ro10['count'];
                    ...
                    var xplace = ["Madurai", "chennai", "coimbatore", "tiruchirappalli","kancheepuram","thiruvallur","vellore","tiruvallur"];
                    var yplace = [<?php echo json_encode($madurai, JSON_HEX_TAG); ?>,
                        <?php echo json_encode($coimbatore, JSON_HEX_TAG); ?>,
                        <?php echo json_encode($chennai, JSON_HEX_TAG); ?>,
                        <?php echo json_encode($tiruchirappalli, JSON_HEX_TAG); ?>,
                        <?php echo json_encode($kancheepuram, JSON_HEX_TAG); ?>,
                        <?php echo json_encode($thiruvallur, JSON_HEX_TAG); ?>,
                        <?php echo json_encode($vellore, JSON_HEX_TAG); ?>,
                        <?php echo json_encode($tiruvallur, JSON_HEX_TAG); ?>
